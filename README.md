...
Comfyui nodes for saving, combining, building prompts

To get the most out of the Shaker Node Suite, you should treat it as a dynamic prompt-building factory rather than just a collection of static text boxes. The suite is designed to let you rapidly iterate through styles, subjects, and settings with a mix of manual control and randomization.
...
OPEN THE INCLUDED EXAMPLE "TUTORIAL" WORKFLOW: 
...
C. Color Match - takes a reference image, applies color matching incrementally over a batch
